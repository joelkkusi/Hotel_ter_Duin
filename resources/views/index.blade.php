    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4" data-aos="fade-up">
          <a href="/reservation" class="room">
            <figure class="img-wrap">
              <img src="images/singel_2.jpg" alt="no image found" class="img-fluid mb-3">
            </figure>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up">
          <a href="/reservation" class="room">
            <figure class="img-wrap">
              <img src="images/family_2.jpg" alt="no image found" class="img-fluid mb-3">
            </figure>
            <div class="p-3 text-center room-info">
              <h2>Family Room</h2>
        ...
        <div class="col-md-6 col-lg-4" data-aos="fade-up">
          <a href="/reservation" class="room">
            <figure class="img-wrap">
              <img src="images/luxe_3.jpg" alt="no image found" class="img-fluid mb-3">
            </figure>
            <div class="p-3 text-center room-info">
