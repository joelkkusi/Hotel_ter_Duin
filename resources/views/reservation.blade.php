...
<body>
    ...
    <section class="site-hero inner-page overlay" style="background-image: url(images/netherlands_1.jpg)"
                ...
                <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
                    <div class="row">
                        <div class="col-md-10 ml-auto contact-info">
                            <p><span class="d-block">Address:</span> <span class="text-black"> Kon. Wilhelmina
                                    Boulevard 4, 2202 GR Noordwijk</span></p>
                            {{-- Noah vroeg om deze telefoon nummer --}}
                            <p><span class="d-block">Phone:</span> <span class="text-black"> (+31) 69 666 420</span>
                            </p>
                            <p><span class="d-block">Email:</span> <span class="text-black">
                                    info@HotelderTuin.com</span></p>
                        </div>
                    </div>
                </div>
            </div>
